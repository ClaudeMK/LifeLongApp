...
<nav class="large-2 medium-3 columns" id="actions-sidebar">
    ...
    <br /><br />
    <ul class="side-nav">
        <li class="heading"><?= __('Actions Modalities') ?></li>
        <li><?= $this->Html->link(__('New Modalities'), ['controller' => 'Modalities', 'action' => 'add']) ?> </li>
    </ul>
</nav>
<div class="modalities index large-10 medium-9 columns content">
    <h3><?= __('Modalities') ?></h3>
