...
<nav class="large-2 medium-3 columns" id="actions-sidebar">
    ...
    <br /><br />
    <ul class="side-nav">
        <li class="heading"><?= __('Actions Position Titles') ?></li>
        <li><?= $this->Html->link(__('New Position Titles'), ['controller' => 'PositionTitles', 'action' => 'add']) ?> </li>
    </ul>
</nav>
<div class="positionTitles index large-10 medium-9 columns content">
