 ...
 * Attachments Model
 *
 * @property \App\Model\Table\FormationCompletesTable|\Cake\ORM\Association\BelongsTo $FormationCompletes
 *
...
class AttachmentsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('FormationCompletes', [
    ...
    {
        $rules->add($rules->existsIn(['formation_complete_id'], 'FormationCompletes'));
