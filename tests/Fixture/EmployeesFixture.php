...
class EmployeesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'civilitie_id' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'cell_number' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'additional_Infos' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'last_sent_formation_plan' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'active' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        '_indexes' => [
            'civility_key' => ['type' => 'index', 'columns' => ['civilitie_id'], 'length' => []],
            'employee_key' => ['type' => 'index', 'columns' => ['parent_id'], 'length' => []],
            'position_title_key' => ['type' => 'index', 'columns' => ['position_title_id'], 'length' => []],
    ...
    public $records = [
        [
            'id' => 1,
            'number' => 'Lorem ip',
            'civilitie_id' => 'Lorem ipsum dolor ',
